"""Wrapper: run the pilot max-endpoint experiment (see configs/max_endpoint_pilot.json)."""
import argparse
import sys
...
if __name__ == "__main__":
    ...
    cfg_path = Path(__file__).resolve().parent.parent / "configs" / "max_endpoint_pilot.json"
