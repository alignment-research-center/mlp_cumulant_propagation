"""Wrapper: pilot direct-Edgeworth-max experiment at depths 2, 4 and 6
(widths 16..64, 8 seeds; see configs/direct_edgeworth_max_pilot.json)."""
import argparse
import os
import sys
...
if __name__ == "__main__":
    ...
    base = DirectCfg.from_json(ROOT / "configs" / "direct_edgeworth_max_pilot.json", **overrides)
